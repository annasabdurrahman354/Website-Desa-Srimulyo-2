...
class Index extends Component
{
    ...
    public function mount()
    {
        ...
        $this->orderable         = (new Umkm())->orderable;
    }
    ...
    public function render()
    {
        ...
        $umkms = $query->paginate($this->perPage);

        return view('livewire.admin.umkm.index', compact('query', 'umkms'));
    }
    ...
    public function deleteSelected()
    {
        ...
        Umkm::whereIn('id', $this->selected)->delete();
