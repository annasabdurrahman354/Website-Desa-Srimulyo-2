			...
			<div class="relative w-full h-full max-w-xl md:h-auto">
				...
				<div class="relative bg-white rounded-lg shadow dark:bg-gray-700" wire:loading.remove>
					...
					<div class="flex items-center p-4 border-t border-gray-200 rounded-b dark:border-gray-600">
						<div class="inline-flex flex-wrap rounded-md shadow-sm">
						@if ($clickedUmkm != "")
							@if ($clickedUmkm['url_hubungi'] != '')
								<a href="{{$clickedUmkm['url_hubungi'] ?? ''}}" aria-current="page" class="inline-flex items-center px-2 md:px-4 py-2 text-sm md:text-base font-medium text-white bg-green-600 border border-gray-200 rounded-l-lg hover:bg-green-700 hover:text-white focus:z-10 focus:ring-2 focus:ring-green-700 focus:text-green-700 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-green-500 dark:focus:text-white">
								...
								<a href="{{$clickedUmkm['url_arah'] ?? ''}}" class="inline-flex items-center px-2 md:px-4 py-2 text-sm md:text-base font-medium text-blue-600 bg-white border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-blue-500 dark:focus:text-white">
							...
							@else
								<a href="{{$clickedUmkm['url_arah'] ?? ''}}" aria-current="page" class="inline-flex items-center px-2 md:px-4 py-2 text-sm md:text-base font-medium text-blue-600 bg-white border border-gray-200 rounded-l-lg hover:bg-gray-100 hover:text-blue-700  focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-green-500 dark:focus:text-white">
									<svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 mr-2 fill-current" fill="currentColor" viewBox="0 0 448 512"><!--! Font Awesome Pro 6.3.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M413.6 92.1c4.9-11.9 2.1-25.6-7-34.7s-22.8-11.9-34.7-7l-352 144C5.7 200.2-2.3 215.2 .6 230.2s16.1 25.8 31.4 25.8H208V432c0 15.3 10.8 28.4 25.8 31.4s30-5.1 35.8-19.3l144-352z"/></svg>
									Petunjuk Arah
								</a>
							@endif
							<a href="{{route('guest.umkm.etalase', $clickedUmkm['slug'] ?? '')}}" class="inline-flex items-center px-2 md:px-4 py-2 text-sm md:text-base font-medium text-blue-600 bg-white border border-gray-200 rounded-r-md hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-blue-500 dark:focus:text-white">
