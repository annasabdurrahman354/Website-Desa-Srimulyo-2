         ...
         <div class="flex flex-col">
            ...
            <div class="flex flex-wrap md:flex-nowrap sm:flex-row mb-4 items-center align-middle justify-between space-y-2">
               ...
               <div class="flex flex-nowrap items-center space-x-2 w-full md:w-fit justify-between">
                  ...
                  <!-- dropdown button -->
                  <button id="dropdownTahunDokumenButton" data-dropdown-toggle="dropdownTahunDokumenRadio" class="whitespace-nowrap text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm h-full px-3 py-1.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">
