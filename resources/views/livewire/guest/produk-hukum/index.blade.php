<div class="container w-full mx-auto dark:bg-gray-900">
   <section class="text-gray-600 body-font container px-4 pt-12 pb-12 mx-auto">
         ...
         <div class="flex flex-col">
            ...
            <div class="flex flex-wrap md:flex-nowrap sm:flex-row mb-4 items-center align-middle justify-between space-y-2">
               ...
               <div class="flex flex-nowrap items-center space-x-2 w-full md:w-fit justify-between">
                  ...
                  <div id="dropdownTahunProdukHukumRadio" class="z-10 hidden w-48 bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600">
                     <ul class="p-3 space-y-3 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownTahunProdukHukumButton">
                        <li>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 relative">
         @forelse ( $produkHukums as $produkHukum)
               ...
               <div class="p-5 h-full flex flex-col justify-between">
                  <div>
                     <div class="flex justify-between">
                        <div class="bg-gray-100 text-gray-600 w-fit text-sm font-medium mb-2 px-2.5 py-0.5 rounded-full dark:bg-gray-700 dark:text-gray-400 border border-gray-400">Tahun {{" ".$produkHukum->tahun}}</div>
                        <p class="text-sm text-gray-400">{{$produkHukum->created_at->diffForHumans()}}</p>
                     </div>
                     <div>
                        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{{$produkHukum->judul}}</h5>
                     </div>
                     <p class="line-clamp-3 mb-3 font-normal text-gray-700 dark:text-gray-400">{{$produkHukum->jenis_label}}</p>
                  </div>
                  <div class="flex justify-between items-center w-full">
                     <a href="{{route('guest.produk-hukum.show', $produkHukum->slug)}}" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-blue-500 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
                           Baca Selengkapnya
