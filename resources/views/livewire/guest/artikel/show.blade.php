<div class="container w-full mx-auto dark:bg-gray-900 border-b border-gray-200 dark:border-gray-600">
    <section class="text-gray-600 body-font container px-4 pt-12 pb-12 mx-auto w-full">
      <div class="w-full lg:w-1/2 mx-auto text-center mb-6">
            ...
            <h2 class="my-4">Flowbite Blocks Tutorial - Learn how to get started with custom sections using the Flowbite Blocks</h2>
      ...
      <div class="grid grid-flow-row lg:grid-flow-col lg:grid-cols-6 gap-5">
         ...
         <div class="lg:col-span-2 lg:my-4 w-full grid grid-flow-row grid-rows-1 gap-6">
            <div class="border bg-white border-gray-300 rounded-md shadow-sm p-4">
               ...
               <h6 class="mt-4">Rekomendasi Kategori</h6>
               <div class="mt-2 flex flex-row flex-wrap justify-between gap-2">
                  <a href="#" class="bg-blue-100 hover:bg-blue-200 text-blue-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded-full dark:bg-gray-700 dark:text-blue-400 border border-blue-400">Badge link</a>
