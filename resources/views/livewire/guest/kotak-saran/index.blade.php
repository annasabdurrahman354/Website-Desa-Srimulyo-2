<section class="py-8 md:py-0 h-full md:h-screen flex items-center text-gray-600 body-font bg-gray-50">
  <div class="container px-5 py-2 my-auto mx-auto flex sm:flex-nowrap flex-wrap ">
    <div class="lg:w-2/3 w-full bg-gray-300 shadow-md rounded-lg overflow-hidden mb-4 sm:mb-0 sm:mr-10 flex items-end justify-start relative">
    ...
    <div class="lg:w-1/3 bg-white rounded-lg shadow-md md:flex md:flex-col md:ml-auto w-full px-4 py-4 md:mt-0">
