        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">Usaha</span>
                </div>
            </li>
        </ol>
    </nav>
    ...
    @if ($umkm)
        ...
        @else
            <x-message info>
                    ...
                    Mohon tunggu proses verifikasi UMKM Anda oleh Admin!
            </x-message>
        @endif
    @else
