<form wire:submit.prevent="submit" class="pt-3">
    ...
    <div class="form-group {{ $errors->has('mediaCollections.dokumen_umum_berkas_dokumen') ? 'invalid' : '' }}">
        ...
        <x-dropzone id="berkas_dokumen" name="berkas_dokumen" action="{{ route('admin.dokumen-umums.storeMedia') }}" file-type=".pdf,.docx,.pptx,.xlsx" collection-name="dokumen_umum_berkas_dokumen" max-files="1" />
        <div class="validation-message">
