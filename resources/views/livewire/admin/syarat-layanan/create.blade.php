<form wire:submit.prevent="submit" class="pt-3">
    ...
    <div class="form-group {{ $errors->has('mediaCollections.syarat_layanan_berkas_formulir') ? 'invalid' : '' }}">
        ...
        <x-dropzone id="berkas_formulir" name="berkas_formulir" action="{{ route('admin.syarat-layanans.storeMedia') }}" file-type=".pdf,.docx" collection-name="syarat_layanan_berkas_formulir" max-files="1" />
        <div class="validation-message">
