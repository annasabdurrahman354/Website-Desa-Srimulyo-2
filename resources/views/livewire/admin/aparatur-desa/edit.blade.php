<form wire:submit.prevent="submit" class="pt-3">
    ...
    <div class="form-group {{ $errors->has('mediaCollections.aparatur_desa_foto') ? 'invalid' : '' }}">
        ...
        <x-dropzone id="foto" name="foto" action="{{ route('admin.aparatur-desas.storeMedia') }}" collection-name="aparatur_desa_foto" max-file-size="2" max-width="512" max-height="768" max-files="1" />
        <div class="validation-message">
