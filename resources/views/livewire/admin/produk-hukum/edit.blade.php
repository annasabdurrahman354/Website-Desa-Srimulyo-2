<form wire:submit.prevent="submit" class="pt-3">
    ...
    <div class="form-group {{ $errors->has('mediaCollections.produk_hukum_berkas_dokumen') ? 'invalid' : '' }}">
        ...
        <x-dropzone id="berkas_dokumen" name="berkas_dokumen" action="{{ route('admin.produk-hukums.storeMedia') }}" file-type=".pdf" collection-name="produk_hukum_berkas_dokumen" max-files="1" />
        <div class="validation-message">
