        ...
        <div class="form-group">
            ...
            <div class="flex items-center gap-4 w-full">
                <div class="flex-1 {{ $errors->has('umkm.latitude') ? 'invalid' : '' }}">
                    ...
                    <input oninput="handleLatitudeInput(this)" class="form-control" min="-90" max="90" type="number" step="any" name="latitude" id="latitude" wire:model="umkm.latitude">
                    <div class="validation-message">
                ...
                <div class="flex-1 {{ $errors->has('umkm.longitude') ? 'invalid' : '' }}">
                    ...
                    <input oninput="handleLongitudeInput(this)" class="form-control" min="-180" max="180" type="number" step="any" name="longitude" id="longitude" wire:model="umkm.longitude">
                    <div class="validation-message">
