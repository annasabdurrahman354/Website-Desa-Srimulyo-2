<footer class="p-2 bottom-0 bg-white border-t border-gray-200 dark:border-gray-600 shadow md:px-6 md:py-4 dark:bg-gray-900">
    <div class="container px-1 md:px-4 w-full mx-auto lg:px-4">
        <div class="flex flex-wrap justify-between w-full">
            <div class="">
                <a href="{{route('guest.home')}}" class="flex items-center align-middle">
                    <img src="{{ asset('image/logo-sragen.png') }}" class="h-20 mr-4" alt="Flowbite Logo">
                    <div class="flex flex-col justify-between h-full">
                        ...
                        <div class="text-sm">꧋ꦮꦺꦧ꧀ꦱꦻꦠ꧀ꦉꦱ꧀ꦩꦶꦥꦼꦩꦼꦫꦶꦤ꧀ꦠꦃꦣꦼꦱꦱꦿꦶꦩꦸꦭ꧀ꦪ </div>
                        <div class="text-sm"> ꧋ꦏꦥꦤꦼꦮꦺꦴꦤ꧀ꦒꦺꦴꦤ꧀ꦝꦁꦏꦧꦸꦥꦠꦺꦤ꧀ꦱꦿꦒꦺꦤ꧀ </div>
                    </div>
                </a>
            </div>
    ...
    <div class="flex items-center justify-between align-middle">
        <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" class="hover:underline">KKN UNS K18 2023</a>
        </span>
        <div class="flex space-x-3 md:space-x-6 sm:justify-center">
            <a href="https://api.whatsapp.com/send?phone=62{{substr(getKontak(7)->kontak, 1)}}&text=Halo%2C%20Selamat%20Siang!" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
            ...
            <a href="{{getKontak(3)->kontak}}" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
