<div class="px-2 sm:px-4 py-2 bg-blue-700 dark:bg-gray-700 md:flex md:items-center md:justify-between z-50">
  <div class="container flex flex-wrap items-center justify-between mx-auto">
    <div class="flex gap-3">
      <a href="#" class="text-white hover:text-gray-200 hover:underline flex gap-1 items-center">
          <svg class="w-5 h-5 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/>
          </svg>
          <span class="text-xs md:text-sm">+62-854-323-123</span>
      </a>
      <a href="#" class="text-white hover:text-gray-200 hover:underline flex gap-1 items-center">
          ...
          <span class="text-xs md:text-sm">srimulyo-sragen@desa.id</span>
      </a>
    </div>
